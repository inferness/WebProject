    ...
    <div class="flex justify-center">
        <form class="space-y-4 md:space-y-6 w-[35rem]" action="{{ route('createPostForm', ['communityId' => $community->CommunityId]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="w-1/2">
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('title')
