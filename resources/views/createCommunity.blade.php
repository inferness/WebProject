...
<div class="">
    <h1 class="text-center">Create a New Community</h1>
    <div class="flex justify-center">
        <form class="space-y-4 md:space-y-6 w-[35rem]" action="{{url('createCommunityForm')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <textarea id="Description" name="Description" class="block w-full h-40 p-4 border rounded-lg sm:text-md bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"></textarea>
            </div>         
